...
class PutSubjectUseCase @Inject constructor(
    private val subjectRepository: SubjectRepository
): BaseParamsUseCase<PutSubjectUseCase.Params, String>() {
    data class Params(
        val title: String,
        val titleNew: String,
        val color: String
    ...
    override suspend fun buildParamsUseCaseSuspend(params: Params): String {
        return subjectRepository.putSubject(params.title, params.titleNew, params.color)
    }
}